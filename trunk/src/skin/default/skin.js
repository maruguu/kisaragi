skin = function() {
  return {
    ...
    render: function(cal) {
      var background = '<table border="0" cellspacing="0" cellpadding="0"><tr><td class="curve-corner"><img src="%images%/left-top.gif" /></td><td class="curve" width="120px"></td><td class="curve-corner"><img src="%images%/right-top.gif" /></td></tr><tr><td class="curve" colspan="3"><div id="calendar"></div></td></tr><tr><td id="curve-corner"><img src="%images%/left-bottom.gif" /></td><td class="curve" width="120px"></td><td class="curve-corner"><img src="%images%/right-bottom.gif" /></td></tr></table>';
      background = background.replace(/%images%/g, kisaragi.getSkinFolder());
